...
{
    public partial class AddedSampleDataToDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "cos1@wp.pl", "Jan", "Kowalski" },
                    { 2, "mail@wp.pl", "Andzrej", "Andzejewski" },
                    { 3, "tralalal@wp.pl", "Przemek", "Przemkowski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Na bol glowy", "Apap", "tabletki" },
                    { 2, "Na humor", "Kokaina", "proszek" },
                    { 3, "Na odporosc", "WitaminaC", "tabletki" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, new DateTime(1994, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alicja", "Czarow" },
                    { 3, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Joker", "Batman" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Lykac", 3 });

            migrationBuilder.InsertData(
                table: "PrescriptionMedicaments",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 2, 2, "Wciagac", 5 });

            migrationBuilder.InsertData(
                table: "PrescriptionMedicaments",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 3, 3, "Lykac", 10 });
        }
